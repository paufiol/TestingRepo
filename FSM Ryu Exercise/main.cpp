		...
		switch(state)
		{
			...
			case ST_JUMP_NEUTRAL:
			{
				switch(last_input)
				{
					...
					case IN_RIGHT_DOWN: state = ST_JUMP_FORWARD; break;
					case IN_LEFT_DOWN: state = ST_JUMP_BACKWARD; break;
				}
			}
			break;
			...
			case ST_JUMP_FORWARD:
			{
				switch(last_input)
				{
					...
					case IN_LEFT_AND_RIGHT: state = ST_JUMP_NEUTRAL; break;
					case IN_RIGHT_UP: state = ST_JUMP_NEUTRAL; break;
				}
			}
			break;
			...
			case ST_JUMP_BACKWARD:
			{
				switch(last_input)
				{
					...
					case IN_LEFT_AND_RIGHT: state = ST_JUMP_NEUTRAL; break;
					case IN_LEFT_UP: state = ST_JUMP_NEUTRAL; break;
				}
			}
			break;
			...
			case ST_PUNCH_NEUTRAL_JUMP:
			{
				switch(last_input)
				{
					...
					case IN_LEFT_DOWN: state = ST_PUNCH_BACKWARD_JUMP; break;
				}
			}
			break;
			...
			case ST_PUNCH_FORWARD_JUMP:
			{
				switch(last_input)
				{
					// TODO: Add Links
					case IN_JUMP_FINISH: state = ST_IDLE; break;
					case IN_RIGHT_UP: state = ST_PUNCH_NEUTRAL_JUMP; break;
					case IN_PUNCH_FINISH: state = ST_JUMP_FORWARD;
				}
			}
			break;
			...
			case ST_PUNCH_BACKWARD_JUMP:
			{
				switch(last_input)
				{
					// TODO: Add Links
					case IN_JUMP_FINISH: state = ST_IDLE; break;
					case IN_LEFT_UP: state = ST_PUNCH_NEUTRAL_JUMP; break;
					case IN_PUNCH_FINISH: state = ST_JUMP_BACKWARD;
				}
			}
			break;
