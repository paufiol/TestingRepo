...
bool ModuleSceneSpace::Start()
{
	...
	App->enemies->AddEnemy(ENEMY_TYPES::REDBIRD, 750, 90);
	App->enemies->AddEnemy(ENEMY_TYPES::REDBIRD, 775, 90);
	App->enemies->AddEnemy(ENEMY_TYPES::REDBIRD, 795, 90);
	App->enemies->AddEnemy(ENEMY_TYPES::REDBIRD, 820, 90);
	// TODO 1: Add a new wave of red birds
	
	App->enemies->AddEnemy(ENEMY_TYPES::BROWNCOOKIE, 500, 80);
	return true;
}
